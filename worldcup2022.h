...
class WorldCup2022 : public WorldCup {
 public:
  ...
  // W planszy trzymamy listę pól, a każdy gracz pamięta nr pola, na którym
  // stoi. Gracz w ruchu otrzymuje kości i rzuca nimi lub nie. Następnie
  // przechodzi przez kolejne pola planszy i na każdym z nich wywołuje metodę
  // action.
